...
const funko = {
  ...
  actualizarPrecio: function (nuevoPrecio) {
    ...
    document.writeln(
      `<p>Precio actualizado, el precio nuevo es: ${this.precio}</p>`
    );
  },
  mostrarTitulo: () => {
    document.writeln(`<h2>Funko </h2>`);
  },
};
...
console.log(this); //representa la ventana del navegador en este contexto

console.log('Existe la propiedad codigo: '+ funko.hasOwnProperty('codigo'))
console.log('Existe la propiedad descripcion: '+ funko.hasOwnProperty('descripcion'))